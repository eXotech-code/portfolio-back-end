  ...
  table(src) {
    ...
    if (cap) {
      ...
      if (item.header.length === item.align.length) {
        ...
        l = item.rows.length;
        for (i = 0; i < l; i++) {
          item.rows[i] = splitCells(item.rows[i], item.header.length).map((c3) => {
            return { text: c3 };
          });
        }
...
// .svelte-kit/adapter-node/entries/pages/blog/posts/_slug_/_page.svelte.js
...
var Parser2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${!type ? `${each(tokens, (token) => {
    return `${validate_component(Parser2, "svelte:self").$$render($$result, Object.assign(token, { renderers }), {}, {})}`;
            ...
            default: () => {
              return `${each(header, (headerItem, i) => {
                return `${validate_component(renderers.tablecell || missing_component, "svelte:component").$$render(
                  ...
                  {
                    default: () => {
                      return `${validate_component(Parser2, "svelte:self").$$render($$result, { tokens: headerItem.tokens, renderers }, {}, {})}
              `;
                    }
                  }
                )}`;
              ...
              default: () => {
                return `${each(row, (cells, i) => {
                  return `${validate_component(renderers.tablecell || missing_component, "svelte:component").$$render(
                    ...
                    {
                      default: () => {
                        return `${validate_component(Parser2, "svelte:self").$$render($$result, { tokens: cells.tokens, renderers }, {}, {})}
                `;
                      }
                    }
                  )}`;
    ...
    default: () => {
      return `${each($$restProps.items, (item) => {
        return `${validate_component(renderers.orderedlistitem || renderers.listitem || missing_component, "svelte:component").$$render($$result, Object.assign(item), {}, {
          default: () => {
            return `${validate_component(Parser2, "svelte:self").$$render($$result, { tokens: item.tokens, renderers }, {}, {})}
            `;
          }
        })}`;
      })}`;
    ...
    default: () => {
      return `${tokens ? `${validate_component(Parser2, "svelte:self").$$render($$result, { tokens, renderers }, {}, {})}` : `${escape($$restProps.raw)}`}`;
    }
  })}`}`}` : ``}`}`;
});
var key = {};
...
var SvelteMarkdown = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  combinedOptions = { ...defaultOptions, ...options2 };
  {
    if (preprocessed) {
      ...
      tokens = isInline ? lexer2.inlineTokens(source) : lexer2.lex(source);
      dispatch("parsed", { tokens });
    }
  }
  combinedRenderers = { ...defaultRenderers, ...renderers };
  return `${validate_component(Parser2, "Parser").$$render($$result, { tokens, renderers: combinedRenderers }, {}, {})}`;
});
var css$3 = {
  code: "div.svelte-fqrshq.svelte-fqrshq{display:inline-block;width:fit-content;height:1.45rem;position:relative}div.svelte-fqrshq.svelte-fqrshq:hover{cursor:pointer}div.svelte-fqrshq:hover>span.svelte-fqrshq{background:#ff737a;height:10px}a.svelte-fqrshq.svelte-fqrshq{position:relative;z-index:2;font-weight:400}span.svelte-fqrshq.svelte-fqrshq{position:absolute;bottom:0;height:1px;width:100%;margin:0;background:#000;z-index:1}",
  map: null
};
var PostLink = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"svelte-fqrshq"}"><a${add_attribute("href", href, 0)}${add_attribute("title", title, 0)} class="${"svelte-fqrshq"}">${slots.default ? slots.default({}) : ``}</a>
	<span class="${"svelte-fqrshq"}"></span>
</div>`;
});
var copyIcon = "/_app/immutable/assets/copy-a38a2f8e.svg";
var css$2 = {
...
var c2 = { name: "c", register: c };
var c$1 = c2;
var cpp2 = { name: "cpp", register: cpp };
var cpp$1 = cpp2;
var javascript3 = { name: "javascript", register: javascript2 };
var javascript$1 = javascript3;
var python2 = { name: "python", register: python };
var python$1 = python2;
var shell2 = { name: "shell", register: shell };
var shell$1 = shell2;
var typescript2 = { name: "typescript", register: typescript };
var typescript$1 = typescript2;
var css$1 = {
  code: '.center.svelte-1r0gor9{display:flex;justify-content:center}.outer.svelte-1r0gor9{margin:1rem 0;background:#161616;display:grid;grid-template-columns:1fr 3rem;padding:1rem;width:fit-content}.button-holder.svelte-1r0gor9{padding:1rem}img.svelte-1r0gor9{filter:invert(95%) sepia(2%) saturate(3175%) hue-rotate(314deg) brightness(105%) contrast(104%);width:1rem;height:1rem;cursor:pointer}.error.svelte-1r0gor9{padding:10rem}pre>code{font-family:"IBM Plex Mono";font-size:0.65rem;white-space:pre-wrap}',
  map: null
};
var CodeBlock = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let language;
  let { lang } = $$props;
  let { text } = $$props;
  function getLang() {
  ...
  language = getLang();
  return `<div class="${"center svelte-1r0gor9"}">${language ? `<div class="${"outer svelte-1r0gor9"}"><div>${validate_component(Highlight, "Highlight").$$render($$result, { code: text, language }, {}, {})}</div>
			<div class="${"button-holder svelte-1r0gor9"}"><img${add_attribute("src", copyIcon, 0)} alt="${"copy button"}" class="${"svelte-1r0gor9"}"></div></div>` : `<div class="${"error svelte-1r0gor9"}"><p>ERROR: Highlighting for the specified language &quot;${escape(lang)}&quot; is unavailable.</p></div>`}
</div>`;
});
var css = {
  code: '@charset "UTF-8";.banner.svelte-5apij1.svelte-5apij1{height:60vh}.banner-content.svelte-5apij1.svelte-5apij1{display:grid;grid-template-columns:1fr 1fr}.banner-text.svelte-5apij1.svelte-5apij1{display:flex;flex-direction:column;gap:1rem;padding:1rem}.banner-container.svelte-5apij1.svelte-5apij1{display:flex;gap:1rem;align-items:center}h1.svelte-5apij1.svelte-5apij1{font-size:3rem;font-weight:900}h3.svelte-5apij1.svelte-5apij1{font-size:1.5rem;font-weight:300}hr.svelte-5apij1.svelte-5apij1{border-color:#000;margin:0}.date.svelte-5apij1.svelte-5apij1{font-size:1.25rem}.banner-container-name.svelte-5apij1.svelte-5apij1{font-weight:600}.graphic.svelte-5apij1.svelte-5apij1{padding:2rem}.graphic.svelte-5apij1 img.svelte-5apij1{border:1px solid #000;object-fit:cover;width:100%;max-height:100%}.tags.svelte-5apij1.svelte-5apij1{display:grid;grid-template-columns:repeat(8, max-content);gap:0.5rem}.post.svelte-5apij1.svelte-5apij1{padding:2rem 10rem}.post>p{font-weight:300;text-align:justify}.post>ul{list-style-type:"\u2014"}.post>ul>li{padding-left:1rem;font-family:"Open Sans", sans-serif;font-weight:300}.post>h3{margin-top:1rem;font-size:2.25rem;font-weight:400}.post>p>code{font-family:"IBM Plex Mono";font-weight:400}.post>.code{font-family:"IBM Plex Mono";font-weight:400;font-size:1.25rem}.post>ul>li>img{object-fit:contain;max-width:100%}',
  map: null
};
var Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>${escape(data.title)} - PISKIEWICZ</title>`, ""}`, ""}

<section id="${"banner"}" class="${"banner svelte-5apij1"}"><div class="${"banner-content svelte-5apij1"}"><div class="${"banner-text svelte-5apij1"}"><h1 class="${"svelte-5apij1"}">${escape(data.title)}</h1>
			<p class="${"date svelte-5apij1"}">${escape(data.date)}</p>
			<h3 class="${"svelte-5apij1"}">${escape(data.description)}</h3>
			<div class="${"banner-container svelte-5apij1"}"><p class="${"banner-container-name svelte-5apij1"}">Tags:</p>
				<div class="${"tags svelte-5apij1"}">${each(data.tags, (tag) => {
    return `${validate_component(Tag, "Tag").$$render($$result, { borderColor: tag.colour, name: tag.name }, {}, {})}`;
  })}</div></div>
			<div class="${"banner-container svelte-5apij1"}"><p class="${"banner-container-name svelte-5apij1"}">Author:</p>
				<p>${escape(data.author)}</p></div></div>
		<div class="${"graphic svelte-5apij1"}"><img${add_attribute("alt", data.title, 0)}${add_attribute("src", `../../blog/${data.id}.webp`, 0)} class="${"svelte-5apij1"}"></div></div></section>
<hr class="${"svelte-5apij1"}">
<section id="${"post"}" class="${"post svelte-5apij1"}">${validate_component(SvelteMarkdown, "SvelteMarkdown").$$render(
    $$result,
    {
      source: data.content,
      renderers: { link: PostLink, code: CodeBlock }
    },
    {},
    {}
  )}
...
//# sourceMappingURL=_page.svelte-SN6MB2PK.js.map
